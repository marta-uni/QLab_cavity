...
min_heights = [0.01, 0.01, 0.005, 0.005, 0.003, 0.01, 0.008, 0.006, 0.004, 0.010, 0.010 ]
#files =       [0001, 0002, 0003, 0004, 0011,    0012, 0013,   0014, 0015,   0016, 0017, 0018]
...
with open(output_file, 'w') as file:
    ...
    for title, h in zip(titles_list, min_heights):
        ...
        # Detect peaks
        xpeaks, ypeaks, peak_widths = fn.peaks(frequencies, transmitted, h, 260)
